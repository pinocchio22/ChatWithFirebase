...
class ChatRoomFragment : Fragment() {
    ...
    internal inner class RecyclerViewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        var unreadTotal = 0// group chat room// there are no last message// FieldValue.serverTimestamp is so late//                    a.orderBy("timestamp", Query.Direction.DESCENDING)
                ...
                listenerRegistration =
                        ...
                        .addSnapshotListener(EventListener { value, e ->
                                ...
                                for (document in value!!) {
                                    ...
                                    if ((message.msg != null) && (message.timestamp == null)) {
                                        continue
